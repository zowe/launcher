...
## 3.6.0
- Bugfix: the launcher stops with `ZWEL0078E` when the configuration manager cannot be created, instead of dereferencing NULL. [(#219)](https://github.com/zowe/launcher/issues/219)
