...
#define MSG_COMP_READY          MSG_PREFIX "0075I" " component %s is ready\n"
#define MSG_DEP_STARTING        MSG_PREFIX "0076I" " component %s starting, all dependencies are ready\n"
#define MSG_DEP_WAIT            MSG_PREFIX "0077I" " component %s waiting for dependency '%s' to become ready\n"
#define MSG_DEP_CYCLE           MSG_PREFIX "0078E" " dependency cycle detected in component manifests, starting components in declaration order\n"
#define MSG_DEP_TIMEOUT         MSG_PREFIX "0079W" " timed out waiting for dependencies of component %s, starting anyway\n"
#define MSG_DEP_MISSING         MSG_PREFIX "0080E" " component %s depends on '%s' which is not found or not enabled\n"
